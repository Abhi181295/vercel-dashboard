...
function buildHierarchy(sms: UserWithTargets[], managers: UserWithTargets[], ams: UserWithTargets[]) {
  ...
  ams.forEach(am => {
    if (am.managerId && managerMap.has(am.managerId)) {
      ...
      const virtualManagerId = irtual-m-;
  ...
  return (
    <div className="crm-root">
      ...
      <section className="crm-main">
        ...
        {/* The rest of your component code (IssueDetailsPanel, MetricsModal, styles) would go here */}
        {/* For brevity, I'm omitting them since they're working */}
